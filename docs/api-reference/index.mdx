...
Use the [`ack_generator`](https://pub.dev/packages/ack_generator) builder to turn annotated top-level schemas into immutable model classes. After adding the annotation and a matching `.ack.dart` part directive, run:
